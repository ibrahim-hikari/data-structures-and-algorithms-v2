...
/* 
The simple way to do this challenge is:
    arr.sort()
*/
...
//// Same as Challenge 2 but we just need to use toUppperCase function
...
const sortMeetingsByDay = (arr) => {
    let week = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thuresday', 'Friday', 'Saturday']
    arr.sort((a, b) => {
...
const sortSchedule = arr => {
    ...
    arr.sort((a, b) => {
        const compDay = daysOfWeek.indexOf(a.dayOfWeek) - daysOfWeek.indexOf(b.dayOfWeek);
        if (compDay !== 0) {
            return compDay;
        }
